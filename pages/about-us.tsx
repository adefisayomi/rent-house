    ...
    <Page title="About-Us">
      <div className="bg-primary w-full min-h-screen py-10">
          <div className="w-full max-w-9xl mx-auto overflow-hidden p-4 md:p-2">
            <h1 className="scroll-m-20 md:text-6xl text-5xl text-wrap font-extrabold tracking-tight lg:text-7xl text-black capitalize mb-10">
              What we represent
            </h1>
            ...
            <div className="mt-20 flex flex-col-reverse md:flex-row justify-center items-start md:items-center gap-10">
              ...
              <div className="flex flex-col gap-4 text-black max-w-lg">
                <h2 className="scroll-m-20 pb-2 text-9xl leading-none break-all md:break-normal text-wrap font-semibold tracking-tight first:mt-0 ">
                  Our Mission
                </h2>
